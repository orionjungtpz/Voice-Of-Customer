...
// 건물별 추가 수신자 (필요시 이후 다른 건물도 여기에 추가)
const EXTRA_RECIPIENTS = {
  '포스코센터': ['mo.boo@poscointl.com']
};
...
'사무공간': {
  ...
  'SWC포스코': {
    ...
    roomItems: {
      ...
      '출장본부장실': ['chair','light','TV','airpurifier'],
      '스마트워크센터':['chair','paper'],
    ...
    seatMap: {
      '출장임원실 1':1,'출장임원실 2':1,'출장임원실 3':1,'출장임원실 4':1,'출장본부장실':1,
      '스마트워크센터':60,'PT룸':12,'회의실 1':8, '회의실 2':6,'회의실 3':6, '회의실 4':6, '회의실 5':6, '탕비실':0
    },
    rooms: [
      { group:'출장임원실',     list:['출장임원실 1','출장임원실 2','출장임원실 3','출장임원실 4','출장본부장실'] },
      { group:'스마트워크센터', list:['스마트워크센터'] },
